...
static final List<Project> projects = [
  ...
  Project(
    ...
    imageUrl:
        'https://play-lh.googleusercontent.com/efFcBNqFehYRNd-io13vKMUz1sD7I8huT5QT6fNoG2u_CVdZVS0GwdfZCFseRQMdbQTg=w600-h300-pc0xffffff-pd',
    links: [
      const ProjectLink(
        title: 'Customer App',
        googlePlay:
        ...
        appleStore:
            'https://apps.apple.com/eg/app/findhelpapp/id1450736684',
      ),
      const ProjectLink(
        title: 'Shops App',
        googlePlay:
        ...
        ,
             appleStore:
            'https://apps.apple.com/eg/app/findhelp-shop-owners/id6475237145',
      ),
        const ProjectLink(
        title: 'Restaurant App',
        googlePlay:
            'https://play.google.com/store/apps/details?id=com.extreme.provider',
               appleStore:
            'https://apps.apple.com/eg/app/findhelp-restaurant-owners/id6451415009',
      ),
      const ProjectLink(
        title: 'Delivery App',
        googlePlay:
            'https://play.google.com/store/apps/details?id=com.extreme.find_help_delivery_app',
             appleStore:
            'https://apps.apple.com/eg/app/findhelp-delivery/id6473175356',
      ),
    ],
  ),
  ...
  Project(
    ...
    imageUrl:
        'https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/97/89/4e/97894e36-8024-5d9b-7b84-c0c9cda6a863/AppIcon-0-0-1x_U007emarketing-0-8-0-85-220.png/1200x630wa.png',
    links: [
      const ProjectLink(
        title: 'User App',
        googlePlay:
            'https://play.google.com/store/apps/details?id=net.meatoo.user',
        appleStore:
            'https://apps.apple.com/sa/app/meatoo/id6741719725',
      ),
      const ProjectLink(
        title: 'Meatoo Vendor',
        googlePlay:
            'https://play.google.com/store/apps/details?id=net.meatoo.vendor',
        appleStore:
            'https://apps.apple.com/sa/app/meatoo-vendor/id6742039572',
      ),
           const ProjectLink(
        title: 'Meatoo delivery',
        googlePlay:
            'https://play.google.com/store/apps/details?id=net.meatoo.delivery',
        appleStore:
            'https://apps.apple.com/sa/app/meatoo-delivery/id6741743993',
      ),
    ],
  ),
  ...
  Project(
    ...
    imageUrl:"https://play-lh.googleusercontent.com/U11n5Hm-JmCmx4hgynP4mPOL62wCX6E7z8c3imZLNPMVi7ycIAEeBzRwCpf06uJHlU17vVTNFS5UG-r9Pcwm-g=w526-h296-rw",
