...
class AppData {
  ...
  static const String heroSubtitle = "Flutter Developer with 4+ years of experience.";
  ...
  static const String contactText = "Looking for a rigorous Flutter Developer? Have a project in mind? Let's connect.";
  ...
  static final List<Project> projects = [
    ...
    Project(
      ...
      links: [
        const ProjectLink(
          title: 'App',
          googlePlay: 'https://play.google.com/store/apps/details?id=com.dushka.dushka_burger',
          appleStore: 'https://apps.apple.com/us/app/dushka-burger/id6692616449',
        ),
      ],
    ),
    Project(
      title: 'PetaPen',
      subtitle: 'E-commerce',
      description: 'One-stop shopping app for high-quality stationery, curated for professionals and students.',
      imageUrl:
      ...
      links: [
        const ProjectLink(
          title: 'App',
          googlePlay: 'https://play.google.com/store/apps/details?id=com.company.petaPen',
    ...
    Project(
      ...
      links: [
        const ProjectLink(
          title: 'User App',
          googlePlay: 'https://play.google.com/store/apps/details?id=com.qarah.userapp',
          appleStore: 'https://apps.apple.com/eg/app/qarah-%D9%82%D8%B1%D8%A7%D8%AD/id6749554152',
        ),
        const ProjectLink(
          title: 'Provider App',
          googlePlay: 'https://play.google.com/store/apps/details?id=com.qarah.providerapp',
          appleStore:
    ...
    Project(
      title: 'UCMAS',
      subtitle: 'Education',
      description: 'Interactive mobile application revolutionizing the way students learn and engage with mathematics.',
      imageUrl:
      ...
      links: [
        const ProjectLink(
          title: 'App',
          googlePlay: 'https://play.google.com/store/apps/details?id=ws.bmsc.ucmas',
          appleStore: 'https://apps.apple.com/eg/app/ucmas-get-in-challenge/id6468704261',
        ),
      ],
    ),
    Project(
      ...
      links: [
        const ProjectLink(
          title: 'App',
          googlePlay: 'https://play.google.com/store/apps/details?id=app.neomars.com',
    ...
    Project(
      title: 'Voyager',
      subtitle: 'Travel',
      description: 'Booking app for flights, hotels, and tours across most countries with ease.',
      imageUrl:
      ...
      links: [
        const ProjectLink(
          title: 'App',
          googlePlay: 'https://play.google.com/store/apps/details?id=com.echopos.voyager',
          appleStore: 'https://apps.apple.com/us/app/voyager-traveling/id6504419730',
        ),
      ],
    ),
    Project(
      ...
      subtitle: 'Healthcare',
      description: 'Complete medical app for doctor appointments, video/audio calls, chat, and online payments.',
      imageUrl:
      ...
      links: [
        const ProjectLink(
          title: 'App',
          googlePlay: 'https://play.google.com/store/apps/details?id=com.smoalfkr.smoalfkr',
  ...
  static final List<Experience> experiences = [
    ...
    Experience(
      ...
      description: 'Developed a social media application with Flutter at a software house.',
    ),
    Experience(
      company: 'Freelancer',
    ...
    Experience(
      ...
      description: 'Built and maintained scalable apps for E-commerce and training systems.',
    ),
    Experience(
      company: 'Binary',
      role: 'Flutter Developer',
      period: 'Feb 2023 – Jan 2024',
      description: 'Built and maintained scalable apps for education and training systems.',
    ),
    Experience(
      company: 'Lightbulb Tech',
      role: 'Flutter Developer',
      period: 'Mar 2023 – Dec 2023',
      description: 'Developed educational applications focusing on usability and performance.',
    ),
    Experience(
      company: 'Nebras',
      role: 'Flutter Developer',
      period: 'Sep 2021 – Dec 2023',
      description: 'Developed E-commerce applications focusing on usability and performance.',
    ),
  ];
